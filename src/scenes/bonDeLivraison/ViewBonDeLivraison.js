...
export default function ViewBonDeLivraison() {
    ...
    useEffect(() => {
        BonDeLivraisonService.getBonDeLivraisonById(id)
            .then((response) => {
    ...
    return (
        <Box m="20px">
            <Header title="BON DE LIVRAISON DETAILS" subtitle=" " />
                        ...
                        <CardContent>
                            <Grid item xs={12}>
                                <Typography gutterBottom variant="h5" component="div" style={{ fontSize: 24, textAlign: 'center' }}>
                                    {bill.numeroLivraison}
                                </Typography>
                            </Grid>
                            <Grid container spacing={2}>
                                {renderField('Date de Livraison', bill.dateLivraison)}
                            ...
                            {/* Display bonDeLivraisonDetails in a table */}
                            <TableContainer component={Paper}>
                                <Table>
                                    ...
                                    <TableBody>
                                        {bill.bonDeLivraisonDetails.map((detail) => (
